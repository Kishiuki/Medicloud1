...
function add_barang(){
	...
	http_request('rawat-jalan/pasien_telah_diperiksa/insert-temp', 'POST', {id_pendaftaran: id_pendaftaran, id_obat: id_obat,kode: kode,obat: obat, qty: qty, total: total,cara_pakai: cara_pakai, aturan_pakai:aturan_pakai,isi:isi,harga:harga,satuan:satuan })
		.done(function (result) {
