...
$(document)
  ...
  .on("click", ".link-periksa", function () {
    http_request("rawat-inap/pemeriksaan/search_pendaftaran", "GET", { id: $(this).data("id") }).done(function (result) {
  ...
  .on("click", ".link-checkin-ruangan", function () {
    http_request("rawat-inap/pemeriksaan/search_", "GET", { id: $(this).data("id") }).done(function (result) {
      var data = result.data;
  ...
  .on("click", ".link-tambah-ruangan", function () {
    http_request("rawat-inap/pemeriksaan/tambah_ruangan", "GET", { id: $(this).data("id") }).done(function (result) {
      var data = result.data;
      $modal_id = $modalManageCheckinRuangan;
      $modal_body = $($modal_id).find(".modal-body");
  ...
  .on("click", ".link-checkout-ruangan", function () {
    http_request("rawat-inap/pemeriksaan/search_checkout", "GET", { id: $(this).data("id") }).done(function (result) {
      var data = result.data;
...
function load_data_temp(id = "") {
  $.ajax({
    type: "GET",
    url: "pemeriksaan/load_temp?clinic_id=" + getSelectedClinic() + "&id=" + id,
    data: "",
...
function hapus(id) {
  http_request("rawat-inap/pemeriksaan/hapus_temp", "POST", { id: id }).done(function (result) {
...
function add_barang() {
  ...
  http_request("rawat-inap/pemeriksaan/insert-temp", "POST", {
