...
function add_barang(){
	...
	http_request('rawat-inap/pemeriksaan/insert-temp', 'POST', { clinic_id: getSelectedClinic(),resep_id: $active_id_resep, id_obat: id_obat,kode: kode,obat: obat, qty: qty, total: total,cara_pakai: cara_pakai, aturan_pakai:aturan_pakai,isi:isi,harga:harga,satuan:satuan })
		.done(function (result) {
			load_data_temp();
			$tableData.ajax.reload(null, false);
			$tableDataObat.ajax.reload(null, false)
			$modal_body.find("#satuanobat").val('').trigger("change")
