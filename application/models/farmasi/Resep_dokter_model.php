	...
	function _load_dt($posted)
	{
		...
		$map_data = array_map(function ($dt) {
			...
			return [
				...
				'' . ($dt->status == 2  ? "<div class='tooltip-inner' style='background-color: darkgray;'>Telah Diproses</div>" : "<a href='#' class='btn btn-success btn-xs link-detail-resep' data-id='" . $dt->id_pendaftaran . "'>Proses</a>") . '',
