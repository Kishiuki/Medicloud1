...
class Check_model extends CI_Model
{
	...
	{
		$this->db->select("periksa.nama_pasien,jns.jenis as jenis_periksa,periksa.hasil,periksa.update_hasil_at,periksa.tgl_periksa,periksa.masa_berlaku,periksa.masa_berlaku_opt,periksa.status,pasien.nomor_rm,provider.nama as provider,periksa.id_notes");
