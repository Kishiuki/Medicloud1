...
class Pemeriksaan_model extends CI_Model
{
	...
	function _load_dt($posted, $provider_id = '',$is_export=FALSE)
	{
	...
	function _search_item_jenis_pemeriksaan($where){
		$query=$this->db->order_by('sub_id','ASC')->get_where($this->tableItemJenisPemeriksaan,$where);
		return $query->result_array();
	}
	function _search_subitem_jenis_pemeriksaan($where){
		$query=$this->db->order_by('subitem_id','ASC')->get_where($this->tableSubItemJenisPemeriksaan,$where);
		return $query->result_array();
	}
