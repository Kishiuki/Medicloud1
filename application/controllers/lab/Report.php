...
class Report extends CI_Controller
{
	...
	public function by_periode($act = '', $file_type = '')
	{
		...
		$count_summary = $this->report->count_pemeriksaan_per_provider('', $ym, $clinic_id);
		...
		foreach ($count_summary as $value) {
			...
			if(isset($sum_total[$value->jenis])){
		...
		if ($act != 'export') {
			...
			// 2022-10-31 : looking for header and footer as clinic id
			...
			if ($file_type == 'pdf') {
				...
				$mpdf->SetHTMLFooter('<div class="page-header-pdf"><img src="' . base_url($this->data['doc_setting']->img_doc_footer->path) . '"></div>', '', true);
