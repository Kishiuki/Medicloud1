...
class Other_setting extends CI_Controller
{
	public function __construct()
	{
		...
		$this->data['error_larangan_update']="Maaf. untuk saat ini anda tidak diizinkan melakukan setting pada form ini. silahkan kirimkan dokumen pendukung ke admin medicloud";
	}
