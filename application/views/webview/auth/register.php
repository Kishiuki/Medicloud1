...
<div id="page">
    ...
    <div id="footer-bar" class="footer-bar-1 footer-bar-detached">
        <a href="<?=base_url('webview/lab/pemeriksaan/registrasi');?>"><i class="bi bi-clipboard-plus"></i></i><span>Pendaftaran</span></a>
    ...
    <div class="page-content footer-clear">
       ...
       <div class="card card-style">
           <div class="content">
               ...
               <form method="post" url="#" name="form-register">
	               <p>
	                   Create a Swabtest Account
	               </p>
	               <div class="form-custom form-label form-border form-icon mb-3 bg-transparent">
	                   <i class="bi bi-person-circle font-13"></i>
	                   <input type="text" class="form-control rounded-xs tx-uppercase" name="name" id="c_name" placeholder="Nama Lengkap"/>
	                   <label for="c1" class="color-theme">Username</label>
	                   <span>(required)</span>
	               </div>
	               <div class="form-custom form-label form-border form-icon mb-3 bg-transparent">
	                   <i class="bi bi-at font-16"></i>
	                    <input type="email" class="form-control rounded-xs tx-lowercase" name="email" id="c1" placeholder="Alamat Email"/>
	               ...
	               <div class="form-custom form-label form-border form-icon mb-4 bg-transparent">
	                   <i class="bi bi-asterisk font-13"></i>
	                   <input type="password" class="form-control rounded-xs" id="c3" name="repassword" placeholder="Ulang Password"/>
	               ...
	               <a href="#" id="submit_register" class="btn btn-full gradient-highlight shadow-bg shadow-bg-s mt-4">Create Account</a>
	               <div class="row">
	                   <div class="col-6 text-start">
	                       <a href="#" class="font-11 color-theme opacity-40 pt-4 d-block">Forgot Password?</a>
	                   </div>
	                   <div class="col-6 text-end">
	                       <a href="<?=base_url('webview/auth');?>" class="font-11 color-theme opacity-40 pt-4 d-block">Sign In Account</a>
	                   </div>
	               </div>
	            </form>
           </div>
