			...
			<div class="card-header bg-purple border-bottom bg-warning">
				...
				<?php if (!empty($list_pemeriksaan)) { ?>
					<div class="btn-group pull-right">
						<a href="<?= base_url(conf('path_module_lab') . 'report/by-pemeriksaan/export/excel?clinic_id='.$clinic_id.'&start_date=' . $start_date . '&end_date=' . $end_date . '&provider=' . $provider . '&jenis=' . $jenis . '&hasil_pemeriksaan=' . $hasil_pemeriksaan . '&excel=true'); ?>" target="_blank" download class="btn btn-xs bg-white"><i class="fa fa-file-excel-o tx-success"></i> Download Excel</a>
						<a href="<?= base_url(conf('path_module_lab') . 'report/by-pemeriksaan/export/pdf?clinic_id='.$clinic_id.'&start_date=' . $start_date . '&end_date=' . $end_date . '&provider=' . $provider . '&jenis=' . $jenis . '&hasil_pemeriksaan=' . $hasil_pemeriksaan . '&pdf=true'); ?>" target="_blank" class="btn btn-xs bg-white"><i class="fa fa-file-pdf-o tx-danger"></i> Download PDF</a>
					</div>
				<?php } ?>
			</div>
