...
<body>
	<div class="body-print-pdf">
		...
		<p></p>
		<table width="100%" class="table table-bordered dataTable table-striped table-detail" border="1" cellspacing=0 cellpadding="5" autosize="1" style="border: 1px solid #000">
			<thead>
				<tr>
					<th>No</th>
					<!-- <th>Nama Provider</th> -->
			...
			<tbody>
				...
				$n=1;
				$totals=0;
				if(empty($list_by_provider)) echo '<tr><td colspan="2">Tidak ada data</td></tr>';
