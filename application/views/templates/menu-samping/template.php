	...
	<div class="az-content az-content-dashboard-five">
				...
				<div class="az-header-right">
					...
					<div class="dropdown az-profile-menu">
						...
						<div class="dropdown-menu">
							...
							<a href="https://tawk.to/chat/611cb642d6e7610a49b0b90d/1fdc2ft10" target="_blank" class="dropdown-item"><i class="fa fa-volume-control-phone" aria-hidden="true"></i> Contact Support</a>
			...
			?>
				<div class="form-inline mb-2">
					<div class="input-group">
						<span class="input-group-prepend"><span class="input-group-text bg-primary tx-white"><i class="fa fa-question-circle-o mr-2" data-toggle="tooltip" title="Opsi ini hanya akan muncul untuk akun super-admin yang memiliki akses ke semua klinik (Codewell)"></i> Pilih Klinik </span> </span>
		...
		<div class="az-footer">
			<div class="container-fluid">
				...
				<span> Medicloud V.1.0.2021</span>
				...
				<span>Sistem Monitoring Klinik & Apotik | Design by <a href="http://codewell.co.id" target="_blank">PT. Codewell Tekindo Cemerlang</a></span>
