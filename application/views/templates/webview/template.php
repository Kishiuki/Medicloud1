    ...
    <body class="theme-light">
        ...
        <div class="offcanvas offcanvas-bottom rounded-m offcanvas-detached" id="menu-install-pwa-ios">
         <div class="content">
             ...
             <h1 class="text-center">Install Medicloud App</h1>
             <p class="boxed-text-xl">
              Install Medicloud App on your home screen, and access it just like a regular app. Open your Safari menu and tap "Add to Home Screen".
          </p>
  ...
  <div class="offcanvas offcanvas-bottom rounded-m offcanvas-detached" id="menu-install-pwa-android">
     <div class="content">
         ...
         <p class="boxed-text-l">
             Install Medicloud App to your Home Screen to enjoy a unique and native experience.
         </p>
