	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="card card-dashboard-one">
			<div class="card-header c-header-large">
				...
				<div class="ml-2 mr-3 tx-center label-filter ">
					...
					<select class="form-control input-sm inline-block" style="width: 120px; display: inline-block;" name="filter_pemeriksaan" id="filter_pemeriksaan">
						<option value="">Semua</option>
						<option value=2|3|5>Rawat Jalan</option>
						<option value=0|1|4>Rawat Inap</option>
					</select>
					<label class="ftr align-middle">Asuransi
						<select class="form-control input-sm inline-block" style="width: 120px; display: inline-block;" id="filter_asuransi" name="filter_asuransi"></select>
					</label>
				...
				<table class="table-bordered table-striped minimize-padding-all" id="dataPasiendiperiksa" width="100%" cellspacing="0">
					<thead>
						<tr>
							...
							<th><?= lang('label_tgl_pembayaran'); ?></th>
							<th><?= lang('label_cara_pembayaran'); ?></th>
						</tr>
					</thead>
				</table>
			</div>
		...
		<form method="POST" name="form-manage-pembayaran">
			<div class="modal-content modal-content-demo">
				...
				<div class="modal-body">
					<span class="id_asuransi hide"></span>
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top-dashed">
							<div class="col-sm-12">
								<dl class="row mb-0">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top-dashed">
							<div class="col-sm-12">
								<dl class="row mb-0 ">
									<dt class="col-sm-5">Cara Pembayaran </dt>
									<dd class="col-sm-1">:</dd>
									<dd class="col-sm-6">
										<!-- <div class="btn-group"> -->
											<label class="btn btn-xs btn-primary"><input type="radio" name="cara_pembayaran" value="Tunai"> Tunai</label>
											<label class="btn btn-xs btn-info"><input type="radio" name="cara_pembayaran" value="Non tunai"> Non Tunai</label>
											<label class="btn btn-xs btn-warning"><input type="radio" name="cara_pembayaran" value="Asuransi"> Asuransi/BPJS</label>
										<!-- </div> -->
									</dd>
								</dl>
							</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top-dashed">
							<div class="col-sm-12">
								<dl class="row mb-0 ">
									<dt class="col-sm-5">Nominal Bayar</dt>
