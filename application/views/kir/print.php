...
<body>
	<div class="body-print-pdf">
		...
		<table style="margin-left: 30px">
			...
			<tr>
				<td width="130px">Diagnosa</td>
				<td>:</td>
				<td><?=(isset($data_periksa->diagnosa)) ? $data_periksa->diagnosa : '-';?></td>
			</tr>
		</table>
		</p>
		<?php if (isset($data_periksa->lama_mc) && $data_periksa->lama_mc > 0) {
		...
		<table width="100%">
			<tr>
				...
				<td width="50%" align="center">
					...
					<?= (isset($doc_setting_profile->kabupaten)) ? ucwords($doc_setting_profile->kabupaten) : ""; ?>, <?= dateIndo(date("Y-m-d H:i:s")); ?><br>
					</p>
				</td>
			</tr>
			<tr>
