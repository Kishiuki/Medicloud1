	...
	<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card card-dashboard-one">
			<div class="card-header border c-header">
				...
				<div class="ml-3 mr-3 tx-center ">
					<label class="ftr align-middle">
						<span class="tx-white">Filter Asuransi</span> 
						<select class="form-control input-sm inline-block" style="width: 150px; display: inline-block;" name="filter_asuransi" id="filter_asuransi">
						</select>
						</label>
				</div>
