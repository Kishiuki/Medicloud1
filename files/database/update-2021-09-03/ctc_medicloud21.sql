...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2021 at 06:35 AM
...
(3, 'Setting', 12, '/admin/administrative', 'fa-cogs', 'c-privilege', 'create-update-user', 1),
(12, 'Master Data', 11, '/master-data', 'fa-database', 'c-master', '', 1),
(13, 'Farmasi', 6, '/farmasi', 'fa fa-stethoscope', 'c-farmasi', '', 1),
(15, 'Pendaftaran', 1, '/pendaftaran', 'fa fa-address-book-o', 'c-register', '', 0),
(16, 'Rawat Jalan', 3, '/rawat-jalan', 'fa fa-ambulance', 'c-rawatjalan', '', 1),
(17, 'Kunjungan IGD', 2, '/kunjunganIGD', 'fa fa-heartbeat', 'c-igd', '', 0),
(18, 'Billing', 7, '/billing', 'fa fa-cart-plus', 'c-billing', '', 0),
(19, 'BPJS', 9, '/bpjs', 'fa fa-plus-circle', 'c-bpjs', '', 0),
(20, 'KIR', 5, '/kir', 'fa fa-file-text-o', 'c-kir', '', 0),
(21, 'Rawat Inap', 4, '/rawat-inap', 'fa fa-bed', 'c-rawatinap', '', 1),
(22, 'Laboratorium', 9, '/lab/pasien', 'fas fa-hospital-o', 'c-lab-pasien', '', 1),
(23, 'Keuangan', 10, '/keuangan', 'fa fa-usd', 'c-keuangan', '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `c_doc_requirements`
--

CREATE TABLE `c_doc_requirements` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `c_doc_requirements`
--

INSERT INTO `c_doc_requirements` (`id`, `code`, `title`, `path`, `content`, `timestamp`) VALUES
(3, 'img_doc_footer', 'Gambar untuk Footer Dokumen', 'assets/img/docs/img_doc_footer.png', 'png', '2021-08-16 23:38:22'),
(2, 'img_doc_header', 'Gambar untuk Header Dokumen', 'assets/img/docs/img_doc_header.png', 'png', '2021-08-16 23:17:03'),
(4, 'img_ttd_validator', 'Gambar TTD validator', 'assets/img/docs/img_ttd_validator.png', 'png', '2021-08-17 00:03:14'),
(5, 'img_doc_header_kwitansi', 'Gambar untuk Header Kwitansi', 'assets/img/docs/img_doc_header_kwitansi.png', 'png', '2021-08-17 01:12:12'),
(6, 'text_city_of_klinik', '', '', 'Ngawi', '2021-08-24 06:03:37'),
(7, 'img_doc_logo', 'Gambar untuk Logo', 'assets/img/docs/img_doc_logo.png', 'png', '2021-08-24 08:15:01');
...
(5, 12, 'Jadwal Dokter', 'master-data/jadwal_dokter', 'c-dokter', '', 2, 1),
(2, 12, 'Dokter', 'master-data/dokter', 'c-dokter', '', 1, 1),
(3, 12, 'Supplier', 'master-data/supplier', 'c-supplier', '', 10, 1),
(4, 12, 'Rekanan', 'master-data/rekanan', 'c-rekanan', '', 11, 1),
(10, 12, 'Poliklinik', 'master-data/poli', 'c-poli', '', 5, 1),
(7, 12, 'Diagnosa', 'master-data/diagnosis', 'c-diagnose', '', 8, 1),
(8, 12, 'Asuransi', 'master-data/asuransi', 'c-asuransi', '', 9, 1),
(9, 12, 'Perujuk', 'master-data/perujuk', 'c-perujuk', '', 7, 1),
(11, 13, 'Obat', 'farmasi/obat', 'c-obat', '', 4, 1),
(12, 12, 'Karyawan', 'master-data/karyawan', 'c-karyawan', '', 3, 1),
(13, 12, 'Ruangan', 'master-data/ruangan', 'c-ruangan', '', 4, 1),
(14, 13, 'Pembelian', 'farmasi/pembelian', 'c-pembelian', '', 2, 1),
(15, 13, 'Penjualan', 'farmasi/penjualan', 'c-penjualan', '', 3, 1),
(16, 13, 'Hutang', 'farmasi/hutang', 'c-hutang', '', 5, 1),
(17, 13, 'Piutang', 'farmasi/piutang', 'c-piutang', '', 6, 1),
(18, 12, 'Layanan Poliklinik', 'master-data/layanan_poli', 'c-poliklinik', '', 6, 1),
(19, 16, 'Antrian pemeriksaan', '/rawat-jalan/antrian_pemeriksaan', 'c-antrianperiksa', '', 2, 1),
(20, 16, 'Pasien telah diperiksa', '/rawat-jalan/pasien_telah_diperiksa', 'c-antrianperiksa', '', 3, 1),
(21, 16, 'Data pasien', '/rawat-jalan/data_pasien', 'c-datapasien', '', 4, 1),
(22, 16, 'Antrian ditunda', '/rawat-jalan/antrian_ditunda', 'c-c-antrianperiksa', '', 5, 1),
(24, 13, 'Laporan', 'farmasi/laporan', 'c-laporan', '', 8, 1),
(25, 3, 'Account Setting', '/admin/administrative', 'c-privilege', 'create-update-user', 1, 1),
(26, 3, 'Other Setting', '/admin/other_setting', 'c-other_setting', '', 2, 1),
(27, 21, 'Koreksi tindakan', '/rawat-inap/koreksi_tindakan', 'c-koreksitindakan', '', 2, 1),
(28, 21, 'Pemeriksaan', '/rawat-inap/pemeriksaan', 'c-pemeriksaan-igd', '', 1, 1),
(29, 13, 'Resep Dokter', 'farmasi/resep_dokter', 'c-resep_dokter', '', 1, 1),
(30, 22, 'Pasien Lab', 'lab/pasien', 'lab::pasien', '', 1, 1),
(31, 22, 'Pemeriksaan Lab', 'lab/pemeriksaan', 'lab::pemeriksaan', '', 2, 1),
(32, 22, 'Report Lab', 'lab/report', 'lab::report', '', 3, 1),
(33, 22, 'Pengaturan Umum Lab', 'lab/administrative', 'lab::admin', '', 14, 1),
(34, 22, 'Pengaturan Tarif Lab', 'lab/setting-tarif', 'lab::tarif', '', 13, 1),
(35, 22, 'Cetak Kwitansi', 'lab/kwitansi', 'lab::kwitansi', '', 4, 1),
(36, 23, 'Laporan', '/keuangan/pemasukan', 'c-pemasukan', '', 1, 1),
(37, 23, 'Pengeluaran', '/keuangan/pengeluaran', 'c-pengeluaran', '', 2, 1);
...
(3, 'admin@codewell.co.id', '87d9bb400c0634691f0e3baaf1e2fd0d', 'AMAR', '', '2021-08-25 13:18:38', 1);
...
CREATE TABLE `c_users` (
  ...
  `accessibility_base` text COLLATE utf8_unicode_ci NOT NULL,
  `actions_code_base` text COLLATE utf8_unicode_ci NOT NULL,
  ...
  `provider_id` int(4) NOT NULL DEFAULT 1,
...
INSERT INTO `c_users` (`uid`, `uname`, `passwd`, `email`, `name`, `accessibility_base`, `actions_code_base`, `accessibility`, `actions_code`, `level`, `last_page`, `related_pic`, `template`, `lang`, `profile`, `provider_id`, `enabled`, `created_by`, `created_at`, `update_by`, `updated_at`) VALUES
(136793619, 'admin@codewell.co.id', '87d9bb400c0634691f0e3baaf1e2fd0d', 'admin@codewell.co.id', 'Admin', '', '', 'c::setting, c::games', '', 'c-spadmin', '', 0, 'menu-samping', 'indonesia', '136793619.png', 1, 1, '', '2021-01-04 14:26:24', '', '2021-09-01 01:39:26'),
(35234607, 'amar', '87d9bb400c0634691f0e3baaf1e2fd0d', 'amar@gmail.com', 'dr Amar', 'c-register,c-igd,c-rawatjalan,c-rawatinap,c-kir,c-farmasi,c-billing,c-lab-pasien,c-keuangan,c-master,c-privilege', 'c-privilege^create-update-user', 'c-antrianperiksa,c-datapasien,c-c-antrianperiksa,c-pemeriksaan-igd,c-koreksitindakan,c-resep_dokter,c-obat,lab::pasien,lab::pemeriksaan,lab::report,lab::kwitansi,lab::tarif,lab::admin,c-pemasukan,c-pengeluaran,c-dokter,c-karyawan,c-ruangan,c-poli,c-poliklinik,c-perujuk,c-diagnose,c-asuransi,c-supplier,c-rekanan,c-privilege,c-other_setting', '', '', '', 0, 'menu-samping', 'indonesia', '136793619.png', 1, 1, '', '2021-06-24 21:55:24', '', '2021-08-31 04:24:16');

-- --------------------------------------------------------

--
-- Table structure for table `fix_agama`
--

CREATE TABLE `fix_agama` (
  `id_agama` int(11) NOT NULL,
  `nama_agama` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `fix_agama`
--

INSERT INTO `fix_agama` (`id_agama`, `nama_agama`) VALUES
(1, 'Islam'),
(2, 'Kristen'),
(3, 'Katolik'),
(4, 'Hindu'),
...
--
-- Table structure for table `fix_gol_darah`
--

CREATE TABLE `fix_gol_darah` (
  `id_gol_darah` int(100) NOT NULL,
  `nama_gol_darah` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `fix_gol_darah`
--

INSERT INTO `fix_gol_darah` (`id_gol_darah`, `nama_gol_darah`) VALUES
(1, 'A'),
(2, 'B'),
(3, 'AB'),
(4, 'O');
...
--
-- Table structure for table `fix_status_pernikahan`
--

CREATE TABLE `fix_status_pernikahan` (
  `id_status_pernikahan` int(30) NOT NULL,
  `nama_status_pernikahan` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `fix_status_pernikahan`
--

INSERT INTO `fix_status_pernikahan` (`id_status_pernikahan`, `nama_status_pernikahan`) VALUES
(1, 'Lajang'),
(2, 'Menikah'),
(3, 'Duda'),
(4, 'Janda');
...
CREATE TABLE `lab_data_pasien` (
  ...
  `akun_id_pasien` int(5) NOT NULL DEFAULT 0,
  `reg_as` varchar(50) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4;
...
(7, 'Test import', '12346!!8107', 3, '', 'perempuan', 'batam', '1991-01-04', 'jln success', '', '', '', 1, '2021-08-12 14:49:26', 'demo', 0, 1, '6', NULL, '', 1, '2021-08-12', 'CTC Admin', 'import:35234607-20210812024926-9540', '', 0, ''),
(6, 'Test import', '12345!!7702', 2, '', 'laki-laki', 'batam', '1991-01-03', 'jln success', '', '', '', 1, '2021-08-12 14:49:26', 'demo', 0, 1, '6', NULL, '', 1, '2021-08-12', 'CTC Admin', 'import:35234607-20210812024926-9540', '', 0, ''),
(5, 'Antok tri suaka', '432342343', 1, '', 'laki-laki', 'Ngawi', '2005-08-09', 'Ngawi', '09837098', 'antok@gmail.com', '', 1, '2021-08-09 14:45:11', '136793619', 0, 1, '6', NULL, '', 0, '0000-00-00', '', '', 'IDN', 0, '');
...
(1, 1, 5, 'Antok tri suaka', 1, 47, '2021-08-30', '2021-08-30 12:00:00', '', '3', 6, '2021-08-30 10:07:13', '', 'Reaktif', '2021-08-30 10:08:00', '', 1, 'day', 'SELESAI', '17', '2021-08-30 03:09:14', 0, NULL, '', '', '', 0, NULL, '', '', 200000, 200000, '', '', 0, 1, '', NULL),
(2, 2, 5, 'Antok tri suaka', 1, 45, '2021-08-30', '2021-08-30 12:00:00', '', '3', 5, '2021-08-30 10:14:33', '', 'Negatif', '2021-08-30 10:14:00', '', 2, 'day', 'SELESAI', '17', '2021-08-30 03:15:32', 0, NULL, '', '', '', 0, NULL, '', '', 150000, 150000, '', '', 0, 1, '', NULL),
(3, 3, 5, 'Antok tri suaka', 1, 45, '2021-08-30', '2021-08-30 12:00:00', '', '4', 8, '2021-08-30 10:28:49', '', 'Negatif', '2021-08-30 10:29:00', '', 3, 'day', 'SELESAI', '15,17,7', '2021-08-30 03:29:58', 0, NULL, '', '', '', 0, NULL, '', '', 300000, 300000, '', '', 0, 1, '', NULL),
(4, 4, 5, 'Antok tri suaka', 1, 45, '2021-08-30', '2021-08-30 12:00:00', '', '3', 8, '2021-08-30 14:19:47', '', 'Positif', '2021-09-02 14:38:00', '', 3, 'day', 'SELESAI', '13,17,18', '2021-09-02 07:39:12', 0, NULL, '', '', '', 0, NULL, '', '', 300000, 300000, '', '', 0, 1, '', NULL),
(5, 5, 5, 'Antok tri suaka', 1, 1, '2021-08-31', '2021-08-31 12:00:00', '', '3', 6, '2021-08-31 16:57:06', '', 'Reaktif', '2021-09-02 14:16:00', '', 2, 'day', 'SELESAI', '17', '2021-09-02 07:39:17', 0, NULL, '', '', '', 0, NULL, '', '', 200000, 200000, '', '', 0, 1, '', NULL),
(6, 6, 5, 'Antok tri suaka', 1, 1, '2021-09-02', '2021-09-02 12:00:00', '', '3', 6, '2021-09-02 15:48:15', '', 'Non Reaktif', '2021-09-02 15:48:00', '', 1, 'day', 'SELESAI', '18', '2021-09-02 08:48:31', 0, NULL, '', '', '', 0, NULL, '', '', 200000, 0, '', '', 0, 1, '', NULL);
...
(1, 'Medicloud', '', '', '', 'pusat', '2021-01-03 21:09:26', 'admin');
...
--
-- Dumping data for table `lab_detail_pemeriksaan`
--

INSERT INTO `lab_detail_pemeriksaan` (`id`, `id_pemeriksaan`, `nama_pemeriksaan`, `id_jenis`, `id_sampling`, `hasil`, `metode`, `nilai_rujukan`, `created_at`, `created_by`) VALUES
(1, 1, 'Rapid Antibody IgM/IgG Covid 19', 6, 3, 'Reaktif', '-', 'Non Reaktif', '2021-08-30 10:08:08', ''),
(2, 2, 'Rapid Antigen Covid 19', 5, 3, 'Negatif', '-', 'Negatif', '2021-08-30 10:14:54', ''),
(3, 3, 'Rapid Saliva Antigen Covid 19', 8, 4, 'Negatif', 'Saliva', 'Negatif', '2021-08-30 10:29:15', ''),
(4, 4, 'Rapid Saliva Antigen Covid 19', 8, 3, 'Positif', 'Saliva', 'Negatif', '2021-08-30 14:21:12', ''),
(5, 5, 'Rapid Antibody IgM/IgG Covid 19', 6, 3, 'Reaktif', '-', 'Non Reaktif', '2021-09-02 14:16:50', ''),
(6, 6, 'Rapid Antibody IgM/IgG Covid 19', 6, 3, 'Non Reaktif', '-', 'Non Reaktif', '2021-09-02 15:48:31', '');
...
(19, 5, 'Positif', 'Rapid Antigen Covid 19', 'Negatif', 'Negatif', '-', 1, '91705900', '2021-01-07 12:24:06'),
...
(1, '1863789974', 1, 6, '2021-08-01', '0000-00-00', 200000, 0, '136793619', '2021-08-09 14:43:29', 1, '2021-08-25 07:54:54'),
(2, '1863789974', 1, 8, '2021-08-01', '0000-00-00', 300000, 0, '136793619', '2021-08-09 14:43:29', 1, '2021-08-25 07:54:57'),
(3, '1863789974', 1, 5, '2021-08-01', '0000-00-00', 150000, 0, '136793619', '2021-08-09 14:43:29', 1, '2021-08-25 07:54:59');

-- --------------------------------------------------------

--
-- Table structure for table `tbasuransi`
--

CREATE TABLE `tbasuransi` (
  `idAsuransi` int(11) NOT NULL,
...
--
-- Dumping data for table `tbasuransi`
--

INSERT INTO `tbasuransi` (`idAsuransi`, `namaAsuransi`, `telp`, `alamat`, `email`, `creator_id`) VALUES
(1, 'dadsfa', '321312', 'fadfadsf', 'example@gmail.com', '136793619'),
(5, 'Asuransi 1', '89889073928', 'Komp Ruko Buana Central Park No. 31', 'asuransi1@gmail.com', 'CTC Admin'),
(6, 'Asuransi 2', '88938992729', 'Kawasan Industri Anggrek Mas No 33', 'asuransi2@gmail.com', 'CTC Admin');
...
CREATE TABLE `tbdaftardokter` (
  ...
  `spesialisasi` int(50) NOT NULL,
  `notelp` varchar(13) DEFAULT NULL,
  `nip` varchar(40) NOT NULL,
  `position` varchar(50) NOT NULL,
  `idBpjs` varchar(32) DEFAULT NULL,
  `status` varchar(22) NOT NULL DEFAULT 'aktif',
  `creator_id` varchar(30) NOT NULL,
  `createdAt` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbdaftardokter` (`idDokter`, `namaDokter`, `spesialisasi`, `notelp`, `nip`, `position`, `idBpjs`, `status`, `creator_id`, `createdAt`) VALUES
(1, 'Muamar DRs', 4, '089787998212', '44444', 'Dokter', '21112', 'aktif', '136793619', '2021-08-09 17:28:08'),
(45, 'Dr. Wahyudi', 1, '', '12346', 'pimpinan', '', 'nonaktif', '136793619', '2021-08-12 14:43:34'),
(47, 'Dr. Hermawan', 3, '', '12345', '', '', 'aktif', 'CTC Admin', '2021-08-12 14:55:57');

-- --------------------------------------------------------

--
-- Table structure for table `tbdiagnosis`
--

CREATE TABLE `tbdiagnosis` (
  `idDiagnosis` int(200) NOT NULL,
  `kodeDiagnosis` varchar(45) NOT NULL,
  `namaDiagnosis` varchar(50) NOT NULL,
  `deskripsi` text DEFAULT NULL,
  `creator_id` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbdiagnosis`
--

INSERT INTO `tbdiagnosis` (`idDiagnosis`, `kodeDiagnosis`, `namaDiagnosis`, `deskripsi`, `creator_id`) VALUES
(1, 'A0002', 'Killi', 'Killi', '136793619'),
(3, 'IVS', 'Infeksi virus parainfluenza', 'Mengacu kepada sekelompok virus yang menyebabkan infeksi saluran pernafasan.', 'CTC Admin');
...
INSERT INTO `tbjadwaldokter` (`idJadwal`, `dokter`, `hari`, `dari_jam`, `sampai_jam`, `creator_id`) VALUES
(1, 45, 2, '12:00:00', '15:00:00', ''),
(2, 45, 2, '13:00:00', '15:00:00', ''),
(3, 45, 3, '12:00:00', '15:00:00', ''),
(4, 47, 2, '00:00:00', '00:00:00', ''),
(5, 47, 1, '00:00:00', '00:00:00', '');
...
CREATE TABLE `tbkaryawan` (
  ...
  `kodeKaryawan` varchar(100) NOT NULL,
  `namaKaryawan` varchar(255) NOT NULL,
  `alamat` text DEFAULT NULL,
  `notelp` varchar(50) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `bidang` int(50) NOT NULL,
  `creator_id` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tbkaryawan_bidang`
--

CREATE TABLE `tbkaryawan_bidang` (
  `id` int(255) NOT NULL,
  `nama` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbkaryawan_bidang`
--

INSERT INTO `tbkaryawan_bidang` (`id`, `nama`) VALUES
(1, 'Perawat');
...
INSERT INTO `tbl_antrian` (`id_antrian`, `jenis_kunjungan`, `nomor_antrian`, `poli`, `status`, `create_at`, `creator_id`) VALUES
(1, 'Kunjungan Sakit', 'GI-001', 1, '2', '2021-08-30 14:05:04', '136793619'),
(2, 'Kunjungan Sakit', 'SA-001', 2, '2', '2021-08-31 01:20:15', '136793619'),
(3, 'Kunjungan Sakit', 'GI-001', 1, '2', '2021-08-31 09:34:22', '136793619'),
(4, 'Kunjungan Sakit', 'GI-002', 1, '2', '2021-08-31 09:38:12', '136793619'),
(5, 'Kunjungan Sakit', 'GI-003', 1, '0', '2021-08-31 10:06:48', '136793619'),
(6, 'Kunjungan Sakit', 'SA-001', 2, '2', '2021-09-01 01:42:50', '136793619'),
(7, 'Kunjungan Sakit', 'UM-001', 3, '2', '2021-09-01 06:08:36', '136793619'),
(8, 'Kunjungan Sakit', 'SA-002', 2, '2', '2021-09-01 06:10:58', '136793619'),
(9, 'Kunjungan Sakit', 'SA-003', 2, '2', '2021-09-01 08:25:44', '136793619'),
(10, 'Kunjungan Sakit', 'SA-004', 2, '2', '2021-09-01 08:31:28', '136793619'),
(11, 'Kunjungan Sakit', 'GI-001', 1, '2', '2021-09-01 09:02:29', '136793619'),
(12, 'Kunjungan Sakit', 'SA-001', 2, '2', '2021-09-02 06:20:20', '136793619'),
(13, 'Kunjungan Sakit', 'GI-001', 1, '2', '2021-09-03 02:16:51', '136793619'),
(14, 'Kunjungan Sakit', 'SA-001', 2, '2', '2021-09-03 02:23:41', '136793619'),
(15, 'Kunjungan Sakit', 'SA-002', 2, '2', '2021-09-03 04:19:47', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_bayar_hutang`
--

CREATE TABLE `tbl_bayar_hutang` (
  `id_bayar` int(100) NOT NULL,
  `biaya` double NOT NULL,
  `fk_hutang` int(255) NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tbl_bayar_periksa`
--

CREATE TABLE `tbl_bayar_periksa` (
  `id_bayar` int(11) NOT NULL,
  `biaya` double NOT NULL,
  `fk_pendaftaran` int(255) NOT NULL,
...
--
-- Dumping data for table `tbl_bayar_periksa`
--

INSERT INTO `tbl_bayar_periksa` (`id_bayar`, `biaya`, `fk_pendaftaran`, `create_at`, `createdAt`, `creator_id`) VALUES
(1, 1520000, 1, '2021-06-20', '2021-09-03 09:05:32', '136793619'),
(2, 1100000, 2, '2021-08-30', '0000-00-00 00:00:00', '136793619'),
(3, 320000, 3, '2021-03-01', '2021-09-03 09:05:52', '136793619'),
(4, 300000, 4, '2021-01-05', '2021-09-03 09:05:59', '136793619'),
(5, 300000, 5, '2021-08-31', '0000-00-00 00:00:00', '136793619'),
(6, 320000, 6, '2021-08-31', '0000-00-00 00:00:00', '136793619'),
(7, 400000, 4, '2021-05-31', '2021-09-03 09:06:09', '136793619'),
(8, 320000, 7, '2021-08-31', '0000-00-00 00:00:00', '136793619'),
(9, 140000, 8, '2021-08-31', '0000-00-00 00:00:00', '136793619'),
(10, 330000, 10, '2021-05-01', '2021-09-03 09:06:14', '136793619'),
(11, 120000, 11, '2021-09-01', '2021-09-01 13:15:31', '136793619'),
(12, 120000, 12, '2021-06-01', '2021-09-03 09:06:20', '136793619'),
(13, 720000, 13, '2021-09-02', '2021-09-02 09:48:58', '136793619'),
(14, 570000, 20, '2021-02-02', '2021-09-03 09:06:25', '136793619'),
(16, 300000, 17, '2021-09-03', '2021-09-03 08:53:49', '136793619'),
(17, 240000, 24, '2021-09-03', '2021-09-03 10:38:06', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_bayar_piutang`
--

CREATE TABLE `tbl_bayar_piutang` (
  `id_bayar` int(200) NOT NULL,
  `biaya` double NOT NULL,
  `fk_piutang` int(255) NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tbl_biaya_farmasi`
--

CREATE TABLE `tbl_biaya_farmasi` (
  `biaya_id` int(255) NOT NULL,
  `nama` varchar(255) DEFAULT NULL,
  `tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `kategori_biaya` int(255) NOT NULL,
...
--
-- Dumping data for table `tbl_biaya_farmasi`
--

INSERT INTO `tbl_biaya_farmasi` (`biaya_id`, `nama`, `tanggal`, `kategori_biaya`, `total`, `keterangan`, `creator_id`) VALUES
(1, 'Air', '2021-08-30 02:13:48', 1, 120000, 'Bayar air', '136793619'),
(2, 'Listrik', '2021-08-30 02:14:07', 4, 200000, 'Bayar listrik', '136793619'),
(3, 'Air', '2021-07-30 02:21:08', 1, 200000, 'bayar air', '136793619'),
(4, 'Listrik', '2021-08-30 02:21:30', 4, 120000, 'bayar listrik', '136793619');
...
CREATE TABLE `tbl_hutang` (
  `hutang_id` int(255) NOT NULL,
  `transaksibeli_id` int(255) NOT NULL,
...
--
-- Table structure for table `tbl_kategori_biaya_farmasi`
--

CREATE TABLE `tbl_kategori_biaya_farmasi` (
  `kategori_biaya_id` int(255) NOT NULL,
  `nama_kategori` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_kategori_biaya_farmasi`
--

INSERT INTO `tbl_kategori_biaya_farmasi` (`kategori_biaya_id`, `nama_kategori`) VALUES
(1, 'DAM'),
(2, 'stok obat apotek'),
(3, 'lab'),
(4, 'PLN'),
...
--
-- Table structure for table `tbl_kategori_obat`
--

CREATE TABLE `tbl_kategori_obat` (
  `idKategoriobat` int(20) NOT NULL,
  `namaKategoriobat` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_kategori_obat`
--

INSERT INTO `tbl_kategori_obat` (`idKategoriobat`, `namaKategoriobat`) VALUES
(1, 'Herbal');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_layanan_poli`
--

CREATE TABLE `tbl_layanan_poli` (
  `id_poli` int(100) NOT NULL,
  `id_layanan_poli` int(100) NOT NULL,
  `nama_layanan_poli` varchar(100) NOT NULL,
  `kode_layanan_poli` varchar(50) NOT NULL,
  `harga_layanan_poli` double DEFAULT NULL,
  `creator_id` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_layanan_poli`
--

INSERT INTO `tbl_layanan_poli` (`id_poli`, `id_layanan_poli`, `nama_layanan_poli`, `kode_layanan_poli`, `harga_layanan_poli`, `creator_id`) VALUES
(1, 1, 'Whitening', 'Wh45', 200000, '136793619'),
(1, 5, 'Cleaning', 'PGGW', 300000, 'CTC Admin'),
(1, 6, 'Tambal Gigi', '3DFF', 120000, '136793619'),
(1, 7, 'Vitamin Gigi', 'TSK', 20000, '136793619'),
(3, 8, 'Pemeriksaan', '093', 30000, '136793619');
...
CREATE TABLE `tbl_obat` (
  ...
  `satuanobat` int(100) DEFAULT NULL,
  `satuanbeli` int(20) DEFAULT NULL,
  `hargaBeli` int(255) DEFAULT NULL,
  `hargaJual` int(255) DEFAULT NULL,
  `supplier` int(100) DEFAULT NULL,
  `stok` double DEFAULT NULL,
  `stokmin` double DEFAULT NULL,
  `expired` date DEFAULT NULL,
  `isiperSatuanbeli` double DEFAULT NULL,
...
INSERT INTO `tbl_obat` (`idObat`, `kode`, `nama`, `kategori`, `satuanobat`, `satuanbeli`, `hargaBeli`, `hargaJual`, `supplier`, `stok`, `stokmin`, `expired`, `isiperSatuanbeli`, `laba`, `konversi`, `create_at`, `creator_id`) VALUES
(1, 'OBT-0001', 'OBH COMBI', 1, 1, 1, 200000, 210000, 1, 0, 1, '2022-08-10', 1, 5, 5, '2021-09-02 09:35:36', '136793619'),
(2, 'OBT-0002', 'Hermaglo', 1, 1, 1, 20000, 22000, 1, 8, 1, '2021-09-16', 1, 10, 0, '2021-09-02 06:38:11', '136793619');
...
CREATE TABLE `tbl_pasien` (
  ...
  `asuransi_utama` varchar(50) DEFAULT NULL,
...
INSERT INTO `tbl_pasien` (`id_pasien`, `nomor_rm`, `nama_lengkap`, `jenis_kelamin`, `tempat_lahir`, `tgl_lahir`, `umur`, `status_nikah`, `agama`, `gol_darah`, `identitas`, `no_identitas`, `provinsi`, `kabupaten`, `kecamatan`, `alamat`, `no_hp`, `no_telp`, `pekerjaan`, `perusahaan`, `ibu_kandung`, `asuransi_utama`, `no_asuransi`, `create_at`, `createdAt`, `creator_id`) VALUES
(1, 'RM-0001', 'Ali Muamar', 'Laki-laki', 'Batam', '2003-08-06', '18', '2', '2', '2', 'KTP', '31231241212432', '12', '1202', '1202011', 'Batam', '089000321903', '43232323', 'wiraswasta', 'er', 'fff', '', '', '2021-08-02', '2021-09-01 08:38:30', '136793619'),
(2, 'RM-0002', 'Junadai Cahyo', 'Laki-laki', 'Ngawi', '1990-08-08', '31', '2', '2', '2', 'KTP', '6352100012099703', '12', '1202', '1202011', 'ngawi', '0982892828', '00998742', 'Petani', 'Petani', 'Cahyu', '', '', '2021-08-09', '2021-09-01 08:37:58', '136793619'),
(3, 'RM-0003', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', '42', '1', '1', '3', 'KTP', '098389293301', '12', '1201', '1201061', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', '089900342032', '021000021', 'General Admin', 'Codewell', 'Julianifah', '', '', '2021-08-14', '2021-09-01 08:38:03', '136793619'),
(11, 'RM-0006', 'Tes pasien', 'Laki-laki', 'ngawi', '2020-01-01', '21', '1', '1', '1', 'KTP', '12412412424', '11', '1101', '1101010', 'ngawi', '67456', '4657', 'kantor', 'kantor', 'sri', '5', '42345234', '2021-08-16', '2021-09-01 08:38:37', '136793619'),
(12, 'RM-0007', 'Kampreto SI anak Botania', 'Laki-laki', 'ngawi', '1967-08-10', '54', '1', '1', '2', 'KTP', '23423532', '11', '1102', '1102020', 'aceh raya', '4323423', '4234234', 'nganggur', 'ppt code', 'par', '5', '1313123', '2021-08-23', '2021-09-01 13:29:28', '136793619'),
(14, 'RM-0008', 'jancuks', 'Laki-laki', '', '0000-00-00', '', '', '', '', 'KTP', '93874923', '', '', '', '', '', '', '', '', '', '', '', '2021-08-25', '2021-09-01 08:38:12', '136793619');
...
CREATE TABLE `tbl_pemeriksaan` (
  ...
  `id_pendaftaran` int(255) DEFAULT NULL,
  `kesadaran` varchar(200) DEFAULT NULL,
  `anamnesa` text DEFAULT NULL,
  `pemeriksaan_umum` text DEFAULT NULL,
  `alergi` text DEFAULT NULL,
  `sistole` int(100) DEFAULT NULL,
  `diastole` int(100) DEFAULT NULL,
  `tensi` varchar(200) DEFAULT NULL,
  `derajat_nadi` int(100) DEFAULT NULL,
  `nafas` int(100) DEFAULT NULL,
  `suhu_tubuh` int(100) DEFAULT NULL,
  `bb` int(100) DEFAULT NULL,
  `tb` int(100) DEFAULT NULL,
  `catatan_dokter` text DEFAULT NULL,
  `nyeri` int(100) DEFAULT NULL,
  `creator_id` varchar(30) NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_pemeriksaan` (`id_pemeriksaan`, `id_pendaftaran`, `kesadaran`, `anamnesa`, `pemeriksaan_umum`, `alergi`, `sistole`, `diastole`, `tensi`, `derajat_nadi`, `nafas`, `suhu_tubuh`, `bb`, `tb`, `catatan_dokter`, `nyeri`, `creator_id`, `create_at`) VALUES
(1, 1, NULL, 'dfasd', 'fasd', 'fa', 21, 21, '21/21', 21, 21, 21, 21, 21, 'fasd', 12, '136793619', '2021-08-28 00:32:41'),
(2, 2, NULL, 'Dd', '22121', '', 21, 21, '21/21', 21, 21, 22, 55, 145, 'd', 2, '136793619', '2021-08-30 02:04:28'),
(3, 4, NULL, 'fadsf', 'adsfa', 'dfsa', 21, 21, '21/21', 21, 21, 0, 21, 21, 'afdsf', 2, '136793619', '2021-08-30 13:42:12'),
(4, 3, NULL, 'gfsdfg', 'gsdfgs', '21', 21, 21, '21/21', 21, 21, 0, 21, 2121, '2121', 212, '136793619', '2021-08-30 13:57:24'),
(5, 5, 'somnolence', 'fsadf', 'asdf', 'asd', 21, 21, '21/21', 21, 21, 21, 21, 21, '21das', 2, '136793619', '2021-08-30 14:05:04'),
(6, 6, 'somnolence', 'fads', 'fad', 'fa', 21, 21, '21/21', 21, 21, 0, 21, 21, 'adfa', 2, '136793619', '2021-08-31 01:20:15'),
(7, 7, 'somnolence', 'adfa', 'dfa', 'afa', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-08-31 09:34:22'),
(8, 8, 'compos entis', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-08-31 09:38:12'),
(9, 10, 'somnolence', 'dfasd', 'fasd', 'fasdf', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 01:42:50'),
(10, 11, 'sopor', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 06:08:36'),
(11, 12, 'compos entis', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 06:10:57'),
(12, 13, NULL, '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 07:41:01'),
(13, 14, NULL, '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 07:56:02'),
(14, 15, 'compos entis', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 08:25:44'),
(15, 15, NULL, 'dad', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 08:27:16'),
(16, 16, 'somnolence', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 08:31:28'),
(17, 17, NULL, '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 08:33:06'),
(18, 18, NULL, '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 08:46:58'),
(19, 19, 'somnolence', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-01 09:02:29'),
(20, 20, 'somnolence', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-02 06:20:20'),
(21, 21, 'compos entis', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-03 02:16:51'),
(22, 22, 'compos entis', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-03 02:23:41'),
(23, 23, NULL, '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-03 03:08:46'),
(24, 24, NULL, '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-03 03:20:40'),
(25, 25, 'sopor', '', '', '', 0, 0, '', 0, 0, 0, 0, 0, '', 0, '136793619', '2021-09-03 04:19:47');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_pemeriksaan_diagnosa`
--

CREATE TABLE `tbl_pemeriksaan_diagnosa` (
  `id_pem_diagnosa` int(255) NOT NULL,
  `fk_diagnosa` int(255) DEFAULT NULL,
  `fk_pemeriksaan` int(255) DEFAULT NULL,
  `fk_dokter` int(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_pemeriksaan_diagnosa`
--

INSERT INTO `tbl_pemeriksaan_diagnosa` (`id_pem_diagnosa`, `fk_diagnosa`, `fk_pemeriksaan`, `fk_dokter`) VALUES
(1, 1, 1, 45);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_pemeriksaan_tindakan`
--

CREATE TABLE `tbl_pemeriksaan_tindakan` (
  `id_pem_tindakan` int(200) NOT NULL,
  `fk_dokter` int(200) DEFAULT NULL,
  `fk_tindakan` int(200) DEFAULT NULL,
  `fk_pemeriksaan` int(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_pemeriksaan_tindakan`
--

INSERT INTO `tbl_pemeriksaan_tindakan` (`id_pem_tindakan`, `fk_dokter`, `fk_tindakan`, `fk_pemeriksaan`) VALUES
(1, 1, 1, 1),
(2, 1, 6, 1),
(3, 45, 5, 2),
(4, 45, 5, 3),
...
CREATE TABLE `tbl_pendaftaran` (
  ...
  `fk_antrian` int(11) DEFAULT NULL,
  `fk_pasien` int(11) NOT NULL,
  `fk_trans_ruangan` int(200) DEFAULT NULL,
  `dpjp` int(200) DEFAULT NULL,
  `poli` int(200) DEFAULT NULL,
  `perujuk` int(100) DEFAULT NULL,
  `nama_tenaga_perujuk` varchar(200) DEFAULT NULL,
  `alasan_datang` text DEFAULT NULL,
  `keterangan` text DEFAULT NULL,
  `nama_lengkap_pjw` varchar(200) DEFAULT NULL,
  `jenis_kelamin_pjw` varchar(100) DEFAULT NULL,
  `tempat_lahir_pjw` varchar(100) DEFAULT NULL,
  `tgl_lahir_pjw` date DEFAULT NULL,
  `identitas_pjw` varchar(50) DEFAULT NULL,
  `no_identitas_pjw` varchar(100) DEFAULT NULL,
  `no_hp_pjw` varchar(13) DEFAULT NULL,
  `no_telp_pjw` varchar(13) DEFAULT NULL,
  `alamat_pjw` text DEFAULT NULL,
  `no_invoice` varchar(255) NOT NULL,
  `status_rawat` varchar(10) DEFAULT NULL,
  `status_bayar` varchar(2) DEFAULT '0',
  `lama_mc` double NOT NULL,
  `mc_set_on` datetime DEFAULT NULL,
  `create_at` date NOT NULL,
  `createdAt` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `creator_id` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_pendaftaran` (`id_pendaftaran`, `fk_antrian`, `fk_pasien`, `fk_trans_ruangan`, `dpjp`, `poli`, `perujuk`, `nama_tenaga_perujuk`, `alasan_datang`, `keterangan`, `nama_lengkap_pjw`, `jenis_kelamin_pjw`, `tempat_lahir_pjw`, `tgl_lahir_pjw`, `identitas_pjw`, `no_identitas_pjw`, `no_hp_pjw`, `no_telp_pjw`, `alamat_pjw`, `no_invoice`, `status_rawat`, `status_bayar`, `lama_mc`, `mc_set_on`, `create_at`, `createdAt`, `creator_id`) VALUES
(1, NULL, 14, 1, 1, 2, 0, '', '', '', 'jancuks', 'Laki-laki', NULL, '0000-00-00', 'KTP', '93874923', '', '', '', 'INVIGD280821001', '3', '1', 0, NULL, '2021-08-25', '2021-09-01 08:31:08', '136793619'),
(2, NULL, 12, 2, 45, 1, 0, '', '', '', 'Kampreto Anak Si Botania Raya', 'Laki-laki', NULL, '1967-08-10', 'KTP', '23423532', '4323423', '4234234', 'aceh raya', 'INVIGD300821002', '3', '1', 0, NULL, '2021-08-17', '2021-09-01 08:31:11', '136793619'),
(3, NULL, 1, 3, 45, 2, 0, '', '', '', 'Ali Muamar', 'Laki-laki', NULL, '2003-08-06', 'KTP', '31231241212432', '089000321903', '43232323', 'Batam', 'INVIGD300821003', '3', '1', 0, NULL, '2021-08-24', '2021-09-01 08:31:14', '136793619'),
(4, NULL, 11, 4, 1, 2, 0, '', '', '', 'Tes pasien', 'Laki-laki', NULL, '2020-01-01', 'KTP', '12412412424', '67456', '4657', 'ngawi', 'INVIGD300821004', '3', '1', 0, NULL, '2021-08-25', '2021-09-01 08:31:17', '136793619'),
(5, 1, 11, NULL, 1, 1, 0, '', '', '', 'Tes pasien', 'Laki-laki', 'ngawi', '2020-01-01', 'KTP', '12412412424', '67456', '4657', 'ngawi', 'INV300821005', '0', '1', 0, NULL, '2021-08-26', '2021-09-01 08:31:21', '136793619'),
(6, 2, 3, NULL, 45, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV310821006', '0', '1', 0, NULL, '2021-08-25', '2021-09-01 08:31:25', '136793619'),
(7, 3, 3, NULL, 45, 1, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV310821007', '0', '1', 0, NULL, '2021-08-25', '2021-09-01 08:31:28', '136793619'),
(8, 4, 3, NULL, 45, 1, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV310821008', '0', '1', 0, NULL, '2021-08-25', '2021-09-01 08:31:31', '136793619'),
(9, 5, 12, NULL, 1, 1, 0, '', '', '', 'Kampreto Anak Si Botania Raya', 'Laki-laki', 'ngawi', '1967-08-10', 'KTP', '23423532', '4323423', '4234234', 'aceh raya', 'INV310821009', '0', '0', 0, NULL, '2021-08-28', '2021-09-01 08:31:34', '136793619'),
(10, 6, 3, NULL, 45, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV010921001', '0', '1', 0, NULL, '2021-09-01', '2021-09-01 09:16:41', '136793619'),
(11, 7, 1, NULL, 1, 3, 0, '', '', '', 'Ali Muamar', 'Laki-laki', 'Batam', '2003-08-06', 'KTP', '31231241212432', '089000321903', '43232323', 'Batam', 'INV010921002', '0', '1', 0, NULL, '2021-09-01', '2021-09-01 13:08:46', '136793619'),
(12, 8, 3, NULL, 45, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV010921003', '0', '1', 1, '2021-09-01 15:49:08', '2021-09-01', '2021-09-01 15:49:08', '136793619'),
(13, NULL, 11, 5, 45, 2, 0, '', '', '', 'Tes pasien', 'Laki-laki', NULL, '2020-01-01', 'KTP', '12412412424', '67456', '4657', 'ngawi', 'INVIGD010921004', '3', '1', 0, NULL, '2021-09-01', '2021-09-02 09:48:58', '136793619'),
(14, NULL, 1, 6, 45, 2, 0, '', '', '', 'Ali Muamar', 'Laki-laki', NULL, '2003-08-06', 'KTP', '31231241212432', '089000321903', '43232323', 'Batam', 'INVIGD010921005', '3', '0', 0, NULL, '2021-09-01', '2021-09-01 16:05:38', '136793619'),
(15, 9, 3, 7, 45, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV010921006', '3', '0', 0, NULL, '2021-09-01', '2021-09-01 15:38:08', '136793619'),
(16, 10, 2, 8, 47, 2, 0, '', '', '', 'Junadai Cahyo', 'Laki-laki', 'Ngawi', '1990-08-08', 'KTP', '6352100012099703', '0982892828', '00998742', 'ngawi', 'INV010921007', '3', '0', 0, NULL, '2021-09-01', '2021-09-01 15:47:19', '136793619'),
(17, NULL, 3, NULL, 1, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', NULL, '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INVIGD010921008', '4', '1', 0, NULL, '2021-08-02', '2021-09-03 08:50:50', '136793619'),
(18, NULL, 11, 9, 45, 2, 0, '', '', '', 'Tes pasien', 'Laki-laki', NULL, '2020-01-01', 'KTP', '12412412424', '67456', '4657', 'ngawi', 'INVIGD010921009', '3', '0', 0, NULL, '2021-09-01', '2021-09-03 10:06:08', '136793619'),
(19, 11, 12, 10, 45, 1, 0, '', '', '', 'Kampreto SI anak Botania', 'Laki-laki', 'ngawi', '1967-08-10', 'KTP', '23423532', '4323423', '4234234', 'aceh raya', 'INV010921010', '3', '0', 0, NULL, '2021-09-01', '2021-09-03 09:56:55', '136793619'),
(20, 12, 3, NULL, 45, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', 'Samosir', '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INV020921001', '0', '1', 1, '2021-09-02 16:38:38', '2021-09-02', '2021-09-02 16:38:38', '136793619'),
(21, 13, 11, NULL, 45, 1, 0, '', '', '', 'Tes pasien', 'Laki-laki', 'ngawi', '2020-01-01', 'KTP', '12412412424', '67456', '4657', 'ngawi', 'INV030921001', '0', '0', 0, '2021-09-03 09:45:04', '2021-09-03', '2021-09-03 09:45:04', '136793619'),
(22, 14, 1, NULL, 45, 2, 0, '', '', '', 'Ali Muamar', 'Laki-laki', 'Batam', '2003-08-06', 'KTP', '31231241212432', '089000321903', '43232323', 'Batam', 'INV030921002', '0', '0', 2, '2021-09-03 09:24:05', '2021-09-03', '2021-09-03 09:24:05', '136793619'),
(23, NULL, 1, 11, 1, 2, 0, '', '', '', 'Ali Muamar', 'Laki-laki', NULL, '2003-08-06', 'KTP', '31231241212432', '089000321903', '43232323', 'Batam', 'INVIGD030921003', '3', '0', 0, NULL, '2021-09-03', '2021-09-03 10:12:18', '136793619'),
(24, NULL, 3, 12, 45, 2, 0, '', '', '', 'Sri Julianifah', 'Wanita', NULL, '1979-08-08', 'KTP', '098389293301', '089900342032', '021000021', 'Samosir kdasjfg lkdjahfsa klajdhflka lkdjashflka', 'INVIGD030921004', '3', '1', 0, NULL, '2021-09-03', '2021-09-03 10:38:06', '136793619'),
(25, 15, 1, 13, 45, 2, 0, '', '', '', 'Ali Muamar', 'Laki-laki', 'Batam', '2003-08-06', 'KTP', '31231241212432', '089000321903', '43232323', 'Batam', 'INV030921005', '2', '0', 0, NULL, '2021-09-03', '2021-09-03 11:23:40', '136793619');
...
CREATE TABLE `tbl_piutang` (
  `piutang_id` int(255) NOT NULL,
  `transaksijual_id` int(255) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tbl_resep_aturan_pakai`
--

CREATE TABLE `tbl_resep_aturan_pakai` (
  `id` int(200) NOT NULL,
  `nama_aturan_pakai` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_resep_aturan_pakai`
--

INSERT INTO `tbl_resep_aturan_pakai` (`id`, `nama_aturan_pakai`) VALUES
(1, '2 x 1');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_resep_cara_pakai`
--

CREATE TABLE `tbl_resep_cara_pakai` (
  `id` int(200) NOT NULL,
  `nama_cara_pakai` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_resep_cara_pakai`
--

INSERT INTO `tbl_resep_cara_pakai` (`id`, `nama_cara_pakai`) VALUES
(1, '15 Menit setelah makan');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_resep_detail`
--

CREATE TABLE `tbl_resep_detail` (
  `resep_detail_id` int(255) NOT NULL,
  `fk_pendaftaran` int(255) NOT NULL,
  `aturan_pakai` int(200) NOT NULL,
  `cara_pakai` int(200) NOT NULL,
  `fk_obat` int(255) NOT NULL,
...
--
-- Dumping data for table `tbl_resep_detail`
--

INSERT INTO `tbl_resep_detail` (`resep_detail_id`, `fk_pendaftaran`, `aturan_pakai`, `cara_pakai`, `fk_obat`, `qty`, `total`, `status`) VALUES
(1, 20, 1, 1, 1, 2, 420000, 2);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_satuan_beli`
--

CREATE TABLE `tbl_satuan_beli` (
  `idSatuanbeli` int(20) NOT NULL,
  `namaSatuanbeli` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_satuan_beli`
--

INSERT INTO `tbl_satuan_beli` (`idSatuanbeli`, `namaSatuanbeli`) VALUES
(1, 'Ampul');
...
INSERT INTO `tbl_satuan_obat` (`idSatuanobat`, `namaSatuanobat`) VALUES
(1, 'Ampul');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_transaksi_beli`
--

CREATE TABLE `tbl_transaksi_beli` (
  `transaksibeli_id` int(100) NOT NULL,
  `faktur` varchar(200) NOT NULL,
  `tanggal` date NOT NULL,
  `tunai_kredit` varchar(20) NOT NULL,
  `kredit_hari` int(100) DEFAULT 0,
  `jatuh_tempo` date DEFAULT NULL,
  `supplier` int(255) NOT NULL,
  `subtotal` double NOT NULL,
  `diskonsub` double NOT NULL,
...
--
-- Dumping data for table `tbl_transaksi_beli`
--

INSERT INTO `tbl_transaksi_beli` (`transaksibeli_id`, `faktur`, `tanggal`, `tunai_kredit`, `kredit_hari`, `jatuh_tempo`, `supplier`, `subtotal`, `diskonsub`, `grandtotal`, `bayar`, `create_at`, `creator_id`) VALUES
(1, 'FAKTUR-0001', '2021-08-30', 'tunai', 0, '0000-00-00', 1, 1000000, 0, 1000000, 1000000, '2021-08-30 12:14:38', '136793619'),
(2, 'FAKTUR-0002', '2021-09-02', 'tunai', 0, '0000-00-00', 1, 200000, 0, 200000, 200000, '2021-09-02 06:37:43', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_transaksi_beli_detail`
--

CREATE TABLE `tbl_transaksi_beli_detail` (
  `belidetail_id` int(255) NOT NULL,
  `obat` int(200) NOT NULL,
  `qty` int(200) NOT NULL,
  `diskon` int(50) NOT NULL DEFAULT 0,
  `total` double NOT NULL,
  `transaksibeli_id` int(200) NOT NULL,
  `status` int(11) NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_transaksi_beli_detail`
--

INSERT INTO `tbl_transaksi_beli_detail` (`belidetail_id`, `obat`, `qty`, `diskon`, `total`, `transaksibeli_id`, `status`, `create_at`) VALUES
(1, 1, 5, 0, 1000000, 1, 1, '2021-08-30 12:14:38'),
(2, 2, 10, 0, 200000, 2, 1, '2021-09-02 06:37:43');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_transaksi_jual`
--

CREATE TABLE `tbl_transaksi_jual` (
  `transaksijual_id` int(255) NOT NULL,
  `faktur` varchar(200) NOT NULL,
  `tanggal` date NOT NULL,
  `tunai_kredit` varchar(20) NOT NULL,
...
--
-- Dumping data for table `tbl_transaksi_jual`
--

INSERT INTO `tbl_transaksi_jual` (`transaksijual_id`, `faktur`, `tanggal`, `tunai_kredit`, `kredit_hari`, `jatuh_tempo`, `dokter`, `subtotal`, `diskonsub`, `grandtotal`, `bayar`, `create_at`, `creator_id`) VALUES
(1, 'FAKTUR-JUAL-0001', '2021-09-02', 'tunai', 0, '0000-00-00', 45, 210000, 0, 210000, 210000, '2021-09-02 06:34:19', '136793619'),
(2, 'FAKTUR-JUAL-0002', '2021-09-02', 'tunai', 0, '0000-00-00', 47, 420000, 0, 420000, 420000, '2021-09-02 06:35:08', '136793619'),
(3, 'FAKTUR-JUAL-0003', '2021-09-02', 'tunai', 0, '0000-00-00', 45, 44000, 0, 44000, 44000, '2021-09-02 06:38:11', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_transaksi_jual_detail`
--

CREATE TABLE `tbl_transaksi_jual_detail` (
  `jualdetail_id` int(255) NOT NULL,
  `obat` int(200) NOT NULL,
  `qty` int(200) NOT NULL,
  `diskon` int(50) NOT NULL DEFAULT 0,
  `total` double NOT NULL,
  `transaksijual_id` int(200) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_transaksi_jual_detail`
--

INSERT INTO `tbl_transaksi_jual_detail` (`jualdetail_id`, `obat`, `qty`, `diskon`, `total`, `transaksijual_id`, `status`) VALUES
(1, 1, 1, 0, 210000, 1, 1),
(2, 1, 2, 0, 420000, 2, 1),
(3, 2, 2, 0, 44000, 3, 1);
...
CREATE TABLE `tbl_triase` (
  `id_triase` int(255) NOT NULL,
  `fk_pendaftaran` int(200) NOT NULL,
  `tanggal` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `triase` varchar(50) DEFAULT NULL,
  `nadi` varchar(50) DEFAULT NULL,
  `sianosis` varchar(50) DEFAULT NULL,
  `crt` varchar(50) DEFAULT NULL,
  `pendarahan` varchar(50) DEFAULT NULL,
  `jalan_nafas` varchar(50) DEFAULT NULL,
  `obstruksi` varchar(50) DEFAULT NULL,
  `trauma` varchar(100) DEFAULT NULL,
  `non_trauma` varchar(100) DEFAULT NULL,
  `irama_nafas` varchar(50) DEFAULT NULL,
  `sistole` int(255) DEFAULT NULL,
  `diastole` int(255) DEFAULT NULL,
  `derajat_nadi` int(255) DEFAULT NULL,
  `suhu_tubuh` int(255) DEFAULT NULL,
  `pernafasan` int(255) DEFAULT NULL,
  `anamnesa` text DEFAULT NULL,
...
INSERT INTO `tbl_triase` (`id_triase`, `fk_pendaftaran`, `tanggal`, `triase`, `nadi`, `sianosis`, `crt`, `pendarahan`, `jalan_nafas`, `obstruksi`, `trauma`, `non_trauma`, `irama_nafas`, `sistole`, `diastole`, `derajat_nadi`, `suhu_tubuh`, `pernafasan`, `anamnesa`, `e`, `m`, `v`, `nyeri`, `creator_id`) VALUES
(1, 1, '2021-08-28 00:32:12', 'tidak gawat &amp; darurat', 'tidak teraba', 'ya', 'lebih dari 2 detik', 'ya', 'tidak', '', '', '', 'normal', 21, 21, 21, 21, 21, 'asd', '212', '21', '21', '1', '136793619'),
(2, 2, '2021-08-30 02:03:16', 'gawat darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '2121', '21', '21', '2', '136793619'),
(3, 3, '2021-08-30 02:03:42', 'darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '212', '2', '2', '', '136793619'),
(4, 4, '2021-08-30 13:29:26', 'darurat', 'tidak teraba', 'ya', 'lebih dari 2 detik', '', '', '', '', '', '', 21, 21, 0, 21, 21, '21', '21', '21', '21', '2', '136793619'),
(5, 13, '2021-09-01 07:40:21', 'gawat darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '', '', '', '', '136793619'),
(6, 14, '2021-09-01 07:55:46', 'darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '', '', '', '', '136793619'),
(7, 17, '2021-09-01 08:32:10', 'darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '', '', '', '', '136793619'),
(8, 18, '2021-09-01 08:46:39', 'darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '', '', '', '', '136793619'),
(9, 23, '2021-09-03 03:08:32', 'darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '', '', '', '', '136793619'),
(10, 24, '2021-09-03 03:20:25', 'darurat', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, '', '', '', '', '', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_triase_diagnosa`
--

CREATE TABLE `tbl_triase_diagnosa` (
  `id_triase_diagnosa` int(255) NOT NULL,
  `fk_diagnosa` int(255) DEFAULT NULL,
  `fk_triase` int(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_triase_diagnosa`
--

INSERT INTO `tbl_triase_diagnosa` (`id_triase_diagnosa`, `fk_diagnosa`, `fk_triase`) VALUES
(1, 3, 1),
(2, 3, 2),
(3, 1, 4),
(4, 3, 5),
...
--
-- Table structure for table `tbperujuk`
--

CREATE TABLE `tbperujuk` (
  `idPerujuk` int(22) NOT NULL,
  `namaPerujuk` varchar(100) NOT NULL,
  `tipe` int(22) NOT NULL,
  `creator_id` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `tbperujuk_tipe`
--

CREATE TABLE `tbperujuk_tipe` (
  `idTipe` int(20) NOT NULL,
  `namaTipe` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbperujuk_tipe`
--

INSERT INTO `tbperujuk_tipe` (`idTipe`, `namaTipe`) VALUES
(1, 'Klinik');
...
CREATE TABLE `tbpoli` (
  `idPoli` int(100) NOT NULL,
  `namaPoli` varchar(100) NOT NULL,
  `kodePoli` varchar(50) NOT NULL,
  `label_antrian` varchar(10) DEFAULT NULL,
  `creator_id` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbpoli` (`idPoli`, `namaPoli`, `kodePoli`, `label_antrian`, `creator_id`) VALUES
(1, 'POLI GIGI', 'PLG', 'GI-', '136793619'),
(2, 'Poliklinik Saraf', 'PLSF', 'SA-', '136793619'),
(3, 'Poliklinik Umum', 'PLBU', 'UM-', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbrekanan`
--

CREATE TABLE `tbrekanan` (
  `idRekanan` int(20) NOT NULL,
  `namaRekanan` varchar(200) NOT NULL,
  `telp` varchar(15) DEFAULT NULL,
  `alamat` text DEFAULT NULL,
  `email` varchar(50) NOT NULL,
  `creator_id` varchar(30) NOT NULL
...
--
-- Dumping data for table `tbrekanan`
--

INSERT INTO `tbrekanan` (`idRekanan`, `namaRekanan`, `telp`, `alamat`, `email`, `creator_id`) VALUES
(1, 'dfad', '323423', 'dfadf', 'amar@gmail.com', '136793619'),
(3, 'Rekanan2', '88938992729', 'Kawasan Industri Anggrek Mas No 33', 'rekanan2@yahoo.com', 'CTC Admin'),
(4, 'Rekanan1', '89889073928', 'Komp Ruko Buana Central Park No. 31', 'rekanan1@gmail.com', 'CTC Admin');
...
CREATE TABLE `tbruangan` (
  `idRuangan` int(100) NOT NULL,
  `namaRuangan` varchar(100) NOT NULL,
  `idKelasruangan` int(100) NOT NULL,
  `idKategoriruangan` int(100) NOT NULL,
  `nomor` varchar(255) NOT NULL,
  `nomor_ranjang` varchar(200) NOT NULL,
...
INSERT INTO `tbruangan` (`idRuangan`, `namaRuangan`, `idKelasruangan`, `idKategoriruangan`, `nomor`, `nomor_ranjang`, `tarif`, `status`, `creator_id`) VALUES
(1, 'ICU', 1, 1, '1', '1', 400000, 'penuh', '136793619'),
(18, 'MELATI', 2, 1, '2', '2', 200000, 'tersedia', '136793619'),
(19, 'MELATI', 2, 1, '2', '3', 120000, 'tersedia', '136793619');

-- --------------------------------------------------------

--
-- Table structure for table `tbruangan_kategori`
--

CREATE TABLE `tbruangan_kategori` (
  `idKategori` int(11) NOT NULL,
  `namaKategori` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbruangan_kategori`
--

INSERT INTO `tbruangan_kategori` (`idKategori`, `namaKategori`) VALUES
(1, 'UMUM');

-- --------------------------------------------------------

--
-- Table structure for table `tbruangan_kelas`
--

CREATE TABLE `tbruangan_kelas` (
  `idKelas` int(11) NOT NULL,
  `namaKelas` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbruangan_kelas`
--

INSERT INTO `tbruangan_kelas` (`idKelas`, `namaKelas`) VALUES
(1, '1'),
(2, '2');
...
--
-- Table structure for table `tbruangan_transaksi`
--

CREATE TABLE `tbruangan_transaksi` (
  `trans_ruangan_id` int(255) NOT NULL,
  `fk_pendaftaran` int(200) NOT NULL,
  `fk_ruangan` int(200) NOT NULL,
  `creator_id` varchar(30) NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `checkin_at` date DEFAULT NULL,
  `checkout_at` date NOT NULL,
  `status_checkout` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbruangan_transaksi`
--

INSERT INTO `tbruangan_transaksi` (`trans_ruangan_id`, `fk_pendaftaran`, `fk_ruangan`, `creator_id`, `create_at`, `checkin_at`, `checkout_at`, `status_checkout`) VALUES
(1, 1, 1, '136793619', '2021-08-30 01:36:42', '2021-08-28', '2021-08-30', 'Sembuh'),
(2, 2, 18, '136793619', '2021-08-30 02:07:15', '2021-08-27', '2021-08-30', 'Sembuh'),
(3, 3, 18, '136793619', '2021-08-31 03:24:13', '2021-08-30', '2021-08-30', 'Meninggal'),
(4, 4, 18, '136793619', '2021-08-31 03:24:20', '2021-08-30', '2021-08-31', 'Meninggal'),
(5, 13, 1, '136793619', '2021-09-01 07:52:16', '2021-09-01', '2021-09-01', 'Dirujuk'),
(6, 14, 18, '136793619', '2021-09-01 09:05:38', '2021-09-01', '2021-09-01', 'Sembuh'),
(7, 15, 1, '136793619', '2021-09-01 08:38:08', '2021-09-01', '2021-09-01', 'Permintaan pasien'),
(8, 16, 1, '136793619', '2021-09-01 08:47:19', '2021-09-01', '2021-09-01', 'Meninggal'),
(9, 18, 1, '136793619', '2021-09-01 08:47:25', '2021-09-01', '2021-09-03', 'Meninggal'),
(10, 19, 19, '136793619', '2021-09-03 02:56:55', '2021-09-01', '2021-09-03', 'Meninggal'),
(11, 23, 19, '136793619', '2021-09-03 03:09:11', '2021-09-03', '2021-09-03', 'Meninggal'),
(12, 24, 19, '136793619', '2021-09-03 03:35:38', '2021-09-03', '2021-09-03', 'Meninggal'),
(13, 25, 1, '136793619', '2021-09-03 04:23:40', '2021-09-03', '0000-00-00', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tbspesialisasi`
--

CREATE TABLE `tbspesialisasi` (
  `idSpesialisasi` int(20) NOT NULL,
  `namaSpesialisasi` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbspesialisasi`
--

INSERT INTO `tbspesialisasi` (`idSpesialisasi`, `namaSpesialisasi`) VALUES
(1, 'THT'),
(2, 'Jantung'),
(3, 'Umum'),
(4, 'GIGI'),
...
INSERT INTO `tbsupplier` (`idSupplier`, `kodeSupplier`, `namaSupplier`, `alamat`, `notelp`, `creator_id`) VALUES
(1, '21', 'PT. Sentosa Jaya', 'Ds. jarbenggi kab sleman', '0928018012', '136793619'),
(2, '32', 'CV. Supplier B', 'Kawasan Industri Anggrek Mas No 33', '88938992729', 'CTC Admin'),
(3, '21BG', 'PT. Supplier A', 'Komp Ruko Buana Central Park No. 31', '89889073928', 'CTC Admin'),
(4, '32SU', 'CV. Supplier B', 'Kawasan Industri Anggrek Mas No 33', '88938992729', 'CTC Admin');

-- --------------------------------------------------------

--
-- Table structure for table `tb_company_detail`
--

CREATE TABLE `tb_company_detail` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `tb_company_detail`
--

INSERT INTO `tb_company_detail` (`id`, `nama`, `kabupaten`, `provinsi`, `alamat`, `no_izin`, `telp`, `email`, `gambar`, `timestamp`) VALUES
(1, 'MEDICLOUD BATAM iNdo', 'Aceh Raya Merdeka', 'kepri indo', 'Komp. Ruko Buana Central Park\r\nBlock Monroe No. 2, Batam', '12345.6789.10.11', '0778-123454', 'medicloudbatam@gmail.com', NULL, '2021-08-25 09:00:58');
...
--
-- Indexes for table `c_doc_requirements`
--
ALTER TABLE `c_doc_requirements`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `fix_agama`
--
ALTER TABLE `fix_agama`
  ADD PRIMARY KEY (`id_agama`);

--
-- Indexes for table `fix_gol_darah`
--
ALTER TABLE `fix_gol_darah`
  ADD PRIMARY KEY (`id_gol_darah`);

--
-- Indexes for table `fix_status_pernikahan`
--
ALTER TABLE `fix_status_pernikahan`
...
--
-- Indexes for table `tbasuransi`
--
ALTER TABLE `tbasuransi`
...
--
-- Indexes for table `tbdiagnosis`
--
ALTER TABLE `tbdiagnosis`
...
--
-- Indexes for table `tbkaryawan_bidang`
--
ALTER TABLE `tbkaryawan_bidang`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_bayar_hutang`
--
ALTER TABLE `tbl_bayar_hutang`
  ADD PRIMARY KEY (`id_bayar`);

--
-- Indexes for table `tbl_bayar_periksa`
--
ALTER TABLE `tbl_bayar_periksa`
  ADD PRIMARY KEY (`id_bayar`);

--
-- Indexes for table `tbl_bayar_piutang`
--
ALTER TABLE `tbl_bayar_piutang`
  ADD PRIMARY KEY (`id_bayar`);

--
-- Indexes for table `tbl_biaya_farmasi`
--
ALTER TABLE `tbl_biaya_farmasi`
...
--
-- Indexes for table `tbl_kategori_biaya_farmasi`
--
ALTER TABLE `tbl_kategori_biaya_farmasi`
  ADD PRIMARY KEY (`kategori_biaya_id`);

--
-- Indexes for table `tbl_kategori_obat`
--
ALTER TABLE `tbl_kategori_obat`
  ADD PRIMARY KEY (`idKategoriobat`);

--
-- Indexes for table `tbl_layanan_poli`
--
ALTER TABLE `tbl_layanan_poli`
  ADD PRIMARY KEY (`id_layanan_poli`);
...
--
-- Indexes for table `tbl_pemeriksaan_diagnosa`
--
ALTER TABLE `tbl_pemeriksaan_diagnosa`
  ADD PRIMARY KEY (`id_pem_diagnosa`);

--
-- Indexes for table `tbl_pemeriksaan_tindakan`
--
ALTER TABLE `tbl_pemeriksaan_tindakan`
  ADD PRIMARY KEY (`id_pem_tindakan`);
...
--
-- Indexes for table `tbl_resep_aturan_pakai`
--
ALTER TABLE `tbl_resep_aturan_pakai`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_resep_cara_pakai`
--
ALTER TABLE `tbl_resep_cara_pakai`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_resep_detail`
--
ALTER TABLE `tbl_resep_detail`
  ADD PRIMARY KEY (`resep_detail_id`);

--
-- Indexes for table `tbl_satuan_beli`
--
ALTER TABLE `tbl_satuan_beli`
  ADD PRIMARY KEY (`idSatuanbeli`);

--
-- Indexes for table `tbl_satuan_obat`
--
ALTER TABLE `tbl_satuan_obat`
  ADD PRIMARY KEY (`idSatuanobat`);

--
-- Indexes for table `tbl_transaksi_beli`
--
ALTER TABLE `tbl_transaksi_beli`
  ADD PRIMARY KEY (`transaksibeli_id`);

--
-- Indexes for table `tbl_transaksi_beli_detail`
--
ALTER TABLE `tbl_transaksi_beli_detail`
  ADD PRIMARY KEY (`belidetail_id`);

--
-- Indexes for table `tbl_transaksi_jual`
--
ALTER TABLE `tbl_transaksi_jual`
  ADD PRIMARY KEY (`transaksijual_id`);

--
-- Indexes for table `tbl_transaksi_jual_detail`
--
ALTER TABLE `tbl_transaksi_jual_detail`
  ADD PRIMARY KEY (`jualdetail_id`);

--
-- Indexes for table `tbl_triase`
--
ALTER TABLE `tbl_triase`
  ADD PRIMARY KEY (`id_triase`);

--
-- Indexes for table `tbl_triase_diagnosa`
--
ALTER TABLE `tbl_triase_diagnosa`
  ADD PRIMARY KEY (`id_triase_diagnosa`);

--
-- Indexes for table `tbperujuk`
--
ALTER TABLE `tbperujuk`
  ADD PRIMARY KEY (`idPerujuk`);

--
-- Indexes for table `tbperujuk_tipe`
--
ALTER TABLE `tbperujuk_tipe`
...
--
-- Indexes for table `tbrekanan`
--
ALTER TABLE `tbrekanan`
...
--
-- Indexes for table `tbruangan_kategori`
--
ALTER TABLE `tbruangan_kategori`
  ADD PRIMARY KEY (`idKategori`);

--
-- Indexes for table `tbruangan_kelas`
--
ALTER TABLE `tbruangan_kelas`
  ADD PRIMARY KEY (`idKelas`);

--
-- Indexes for table `tbruangan_transaksi`
--
ALTER TABLE `tbruangan_transaksi`
  ADD PRIMARY KEY (`trans_ruangan_id`);

--
-- Indexes for table `tbspesialisasi`
--
ALTER TABLE `tbspesialisasi`
...
--
-- Indexes for table `tb_company_detail`
--
ALTER TABLE `tb_company_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nama` (`nama`),
...
--
-- AUTO_INCREMENT for table `c_doc_requirements`
--
ALTER TABLE `c_doc_requirements`
...
--
-- AUTO_INCREMENT for table `fix_agama`
--
ALTER TABLE `fix_agama`
  MODIFY `id_agama` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `fix_gol_darah`
--
ALTER TABLE `fix_gol_darah`
  MODIFY `id_gol_darah` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `fix_status_pernikahan`
--
ALTER TABLE `fix_status_pernikahan`
  MODIFY `id_status_pernikahan` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `tbasuransi`
--
ALTER TABLE `tbasuransi`
  MODIFY `idAsuransi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbdaftardokter`
--
ALTER TABLE `tbdaftardokter`
  MODIFY `idDokter` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `tbdiagnosis`
--
ALTER TABLE `tbdiagnosis`
  MODIFY `idDiagnosis` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbjadwaldokter`
--
ALTER TABLE `tbjadwaldokter`
  MODIFY `idJadwal` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `tbkaryawan_bidang`
--
ALTER TABLE `tbkaryawan_bidang`
...
--
ALTER TABLE `tbl_antrian`
  MODIFY `id_antrian` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_bayar_hutang`
--
ALTER TABLE `tbl_bayar_hutang`
  MODIFY `id_bayar` int(100) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_bayar_periksa`
--
ALTER TABLE `tbl_bayar_periksa`
  MODIFY `id_bayar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tbl_bayar_piutang`
--
ALTER TABLE `tbl_bayar_piutang`
  MODIFY `id_bayar` int(200) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_biaya_farmasi`
--
ALTER TABLE `tbl_biaya_farmasi`
  MODIFY `biaya_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_hutang`
--
ALTER TABLE `tbl_hutang`
  MODIFY `hutang_id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_kategori_biaya_farmasi`
--
ALTER TABLE `tbl_kategori_biaya_farmasi`
  MODIFY `kategori_biaya_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_kategori_obat`
--
ALTER TABLE `tbl_kategori_obat`
  MODIFY `idKategoriobat` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_layanan_poli`
--
ALTER TABLE `tbl_layanan_poli`
  MODIFY `id_layanan_poli` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_obat`
--
ALTER TABLE `tbl_obat`
  MODIFY `idObat` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_pemeriksaan`
  MODIFY `id_pemeriksaan` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tbl_pemeriksaan_diagnosa`
--
ALTER TABLE `tbl_pemeriksaan_diagnosa`
  MODIFY `id_pem_diagnosa` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_pemeriksaan_tindakan`
--
ALTER TABLE `tbl_pemeriksaan_tindakan`
  MODIFY `id_pem_tindakan` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `tbl_pendaftaran`
--
ALTER TABLE `tbl_pendaftaran`
  MODIFY `id_pendaftaran` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tbl_piutang`
--
ALTER TABLE `tbl_piutang`
  MODIFY `piutang_id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_resep_aturan_pakai`
--
ALTER TABLE `tbl_resep_aturan_pakai`
  MODIFY `id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_resep_cara_pakai`
--
ALTER TABLE `tbl_resep_cara_pakai`
  MODIFY `id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_resep_detail`
--
ALTER TABLE `tbl_resep_detail`
  MODIFY `resep_detail_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_satuan_beli`
--
ALTER TABLE `tbl_satuan_beli`
  MODIFY `idSatuanbeli` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_satuan_obat`
--
ALTER TABLE `tbl_satuan_obat`
  MODIFY `idSatuanobat` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_transaksi_beli`
--
ALTER TABLE `tbl_transaksi_beli`
  MODIFY `transaksibeli_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_transaksi_beli_detail`
--
ALTER TABLE `tbl_transaksi_beli_detail`
  MODIFY `belidetail_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_transaksi_jual`
--
ALTER TABLE `tbl_transaksi_jual`
  MODIFY `transaksijual_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_transaksi_jual_detail`
--
ALTER TABLE `tbl_transaksi_jual_detail`
  MODIFY `jualdetail_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_triase`
--
ALTER TABLE `tbl_triase`
  MODIFY `id_triase` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbl_triase_diagnosa`
--
ALTER TABLE `tbl_triase_diagnosa`
  MODIFY `id_triase_diagnosa` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbperujuk`
--
ALTER TABLE `tbperujuk`
  MODIFY `idPerujuk` int(22) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbperujuk_tipe`
--
ALTER TABLE `tbperujuk_tipe`
  MODIFY `idTipe` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbpoli`
--
ALTER TABLE `tbpoli`
  MODIFY `idPoli` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `tbrekanan`
--
ALTER TABLE `tbrekanan`
  MODIFY `idRekanan` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbruangan`
--
ALTER TABLE `tbruangan`
  MODIFY `idRuangan` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tbruangan_kategori`
--
ALTER TABLE `tbruangan_kategori`
  MODIFY `idKategori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbruangan_kelas`
--
ALTER TABLE `tbruangan_kelas`
  MODIFY `idKelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbruangan_transaksi`
--
ALTER TABLE `tbruangan_transaksi`
  MODIFY `trans_ruangan_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbspesialisasi`
--
ALTER TABLE `tbspesialisasi`
  MODIFY `idSpesialisasi` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbsupplier`
--
ALTER TABLE `tbsupplier`
  MODIFY `idSupplier` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_company_detail`
--
ALTER TABLE `tb_company_detail`
